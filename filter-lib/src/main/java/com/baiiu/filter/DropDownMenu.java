...
public class DropDownMenu extends RelativeLayout implements View.OnClickListener, FixedTabIndicator.OnItemClickListener {
    ...
    public void setContentView(View contentView) {
        ...
        LayoutParams paramsList = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
        paramsList.addRule(BELOW, R.id.fixedTabIndicator);
        addView(frameLayoutContainer, paramsList);
